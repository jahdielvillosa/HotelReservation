...
public class loadprevFrame extends javax.swing.JFrame {
    private int xMouse, yMouse;
    private String startDay,startMonth,startYear;
    private String endDay,endMonth,endYear;
    private Hotel database = new Hotel();
    
    
    /**
     * Creates new form loadprevFrame
     */
    public loadprevFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel2.setBackground(new java.awt.Color(238, 239, 247));
        ...
        NoButton.setBackground(new java.awt.Color(204, 51, 0));
        ...
        QuestionLabel.setFont(new java.awt.Font("Swis721 LtEx BT", 0, 14)); // NOI18N
        QuestionLabel.setText("Do you want to use your previous room preference?");
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addComponent(end)
                                .addGap(18, 18, 18)
                                .addComponent(endMonthComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 81, javax.swing.GroupLayout.PREFERRED_SIZE)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addComponent(start)
                                .addGap(18, 18, 18)
                                .addComponent(startMonthComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 81, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        topBar.setBackground(new java.awt.Color(65, 64, 75));
    ...
    private void YesButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_YesButtonActionPerformed
        ...
        //loads guest's previous room type
        database.setPrefRoom(database.getGuestPrevRoomType());
        QuestionLabel.setText("Please enter your preferred dates for reservation.");
        YesButton.setVisible(false);
        NoButton.setVisible(false);
        
        OkButton.setVisible(true);
        startDayComboBox.setVisible(true);
        startMonthComboBox.setVisible(true);
        startYearComboBox.setVisible(true);
        
        endDayComboBox.setVisible(true);
        endMonthComboBox.setVisible(true);
        endYearComboBox.setVisible(true);
    ...
    private void NoButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NoButtonActionPerformed
        ...
        preferenceFrame guestPref = new preferenceFrame();
        guestPref.displayFrame();
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        startMonthComboBox.setVisible(false);
        startYearComboBox.setVisible(false);
        endDayComboBox.setVisible(false);
        endMonthComboBox.setVisible(false);
        endYearComboBox.setVisible(false);
    ...
    /**
     * when ok button is clicked,  first check if the reservation dates
    ...
    private void OkButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OkButtonActionPerformed
        ...
        // must check the reservation dates
        if(isDateValid){
            if(isNotInThePast){  
                // saves the preferred data
                System.out.println(database.getGuestPrevRoomType());
                //display in console and opens the next window
                database.setPrefStartDate(startMonth, startDay, startYear);  //default
                database.setPrefEndDate(endMonth, endDay, endYear);  //default
                result.displayFrame();
                this.setVisible(false);
            }else{
    ...
    public void displayFrame() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(loadprevFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new loadprevFrame().setVisible(true);
            }
        });
    }
    ...
    public boolean checkReservationDate(){
        ...
        //Checks the start year date  if valid
            ...
            if(!"Month".equals(startMonth) && !"Day".equals(startDay) && !"Year".equals(endYear)){
                ...
                if(!"Month".equals(endMonth) && !"Day".equals(endDay) && !"Year".equals(endYear)){
                    ...
                    if(startMonthComboBox.getSelectedIndex() < endMonthComboBox.getSelectedIndex() ){
                        ...
                        //next year is end month
                        if((startYearComboBox.getSelectedIndex() - endYearComboBox.getSelectedIndex()) == 1){ 
                            if("January".equals(endMonth) && "December".equals(startMonth)){
                                isDateValid = true;
                            } 
                        }
                         
                        //only when startdate is December and endDate is January next Year to be valid
                    }else if(startMonthComboBox.getSelectedIndex() > endMonthComboBox.getSelectedIndex() ){
